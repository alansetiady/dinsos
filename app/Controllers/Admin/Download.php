	...
	public function tambah()
	{
		...
		if($this->request->getMethod() === 'post' && $this->validate(
			[
				...
				'gambar'	 	=> [
									'uploaded[gambar]',
					                'mime_in[gambar,image/jpg,image/jpeg,image/gif,image/png,application/pdf,application/doc,application/msword,application/xls,application/xlsx,application/ppt,application/pptx,application/apk]',
					                'max_size[gambar,40960000]',
            					],
        	])) {
