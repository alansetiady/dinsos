...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url('assets/upload/image/'.$site['logo']) ?>" rel="logo">
  <link href="<?php echo base_url('assets/upload/image/'.$site['logo']) ?>" rel="apple-touch-icon">
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v17.0" nonce="mEbFLRC0"></script>
<?php echo metatext(); ?>
